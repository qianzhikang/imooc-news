...
public class CommentController extends BaseController implements CommentControllerApi {
    ...
    public GraceJSONResult createArticle(@Valid CommentReplyBO commentReplyBO,
        ...
        String userFace = getBasicUserList(idSet).get(0).getFace();

        // 3. 保存用户评论的信息到数据库
        commentsService.createComment(commentReplyBO.getArticleId(),
    ...
    public GraceJSONResult list(String articleId,
        ...
        PagedGridResult gridResult = commentsService.queryArticleComments(articleId, page, pageSize);
