                                ...
                                <div class="comment-info-wrapper">
                                    ...
                                    <div class="quote-wrapper" v-show="comment.quoteUserNickname != null">
                                        <span class="quote-content">
                                            <!-- <span>回复“</span> -->
                                            <span><strong>{{comment.quoteUserNickname}}</strong>：</span>
                                            <span v-html="comment.quoteContent"></span>
                                            <!-- <span>”</span> -->
                                        </span>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        var articleList = new Vue({
            ...
            created() {
                ...
                // 根据当前页面的名称，定义为文章的articleId，作为静态化页面的名称
            ...
            methods: {
                ...
                readArticle(articleId) {
                    ...
                    var articleServerUrl = app.articleServerUrl;
                    axios.defaults.withCredentials = true;
                    axios.post(articleServerUrl + "/portal/article/readCounts?articleId=" + articleId)
                    .then(res => {
                        // console.log(JSON.stringify(res.data));
